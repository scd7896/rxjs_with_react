  ...
  return function (Component) {
    return function () {
      ...
      Object(react__WEBPACK_IMPORTED_MODULE_4__["useEffect"])(function () {
        subscription = observable.subscribe(function (newState) {
          return setState(Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_3__["default"])({}, newState));
        });
      }, []);
      return __jsx(Component, Object(_babel_runtime_corejs2_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_2__["default"])({}, state, triggers, observable));
    };
  };
};
...
var App = function App(_ref) {
  ...
  return __jsx("div", null, __jsx("h1", null, "React \uB7FD\uB7FD\uB7FD Rxjs"), __jsx("input", {
    ...
    value: query,
    onChange: onChange
  }), __jsx("div", null, _babel_runtime_corejs2_core_js_object_values__WEBPACK_IMPORTED_MODULE_1___default()(SUBJECT).map(function (value) {
    return __jsx("button", {
      key: value,
  ...
  })), __jsx("ul", null, stories.map(function (story) {
    return __jsx("li", {
      key: story.objectID
    }, __jsx("a", {
      href: story.url || story.stoty_url
    }, story.title || story.story_title));
  })), __jsx("p", null, "\uCFFC\uB9AC\uC5D0 \uB2F4\uAE34 \uAC12\uC740 ".concat(query, " \uC11C\uCE58\uB294:  ").concat(subject)));
};

var query$ = new rxjs__WEBPACK_IMPORTED_MODULE_5__["BehaviorSubject"]('react'); //observable 생성

var subject$ = new rxjs__WEBPACK_IMPORTED_MODULE_5__["BehaviorSubject"](SUBJECT.POPULARITY);
var queryForFetch$ = query$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["debounce"])(function () {
  return Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["timer"])(1000);
}), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["filter"])(function (query) {
  return query !== '';
}));
var fetch$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["combineLatest"])(subject$, queryForFetch$).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["flatMap"])(function (_ref2) {
  var _ref3 = Object(_babel_runtime_corejs2_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_0__["default"])(_ref2, 2),
      subject = _ref3[0],
      query = _ref3[1];

  return axios__WEBPACK_IMPORTED_MODULE_6___default.a.get("http://hn.algolia.com/api/v1/".concat(subject, "?query=").concat(query));
}), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(function (result) {
  return result.data.hits;
}), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["retry"])(3));
/* harmony default export */ __webpack_exports__["default"] = (withObservableStream(Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["combineLatest"])(subject$, query$, fetch$, function (subject, query, stories) {
  return {
    subject: subject,
    query: query,
    stories: stories
  ...
  onChangeQuery: function onChangeQuery(value) {
    return query$.next(value);
  },
  //2번째 인자 대응 함수들
  onSelectSubject: function onSelectSubject(subject) {
    return subject$.next(subject);
  }
}, {
  query: 'react',
...
/***/ "./node_modules/next/dist/build/webpack/loaders/next-client-pages-loader.js?page=%2Fsecond&absolutePagePath=%2FUsers%2Fkimserver%2FGitHub%2FTraB%2FRxJs%2FRxJs_Next_js%2Fpages%2Fsecond.js!./":
/*!*************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/next/dist/build/webpack/loaders/next-client-pages-loader.js?page=%2Fsecond&absolutePagePath=%2FUsers%2Fkimserver%2FGitHub%2FTraB%2FRxJs%2FRxJs_Next_js%2Fpages%2Fsecond.js ***!
  \*************************************************************************************************************************************************************************************************/
/*! no static exports found */
...
var second = function second() {
  return __jsx("div", null, __jsx(_component_App__WEBPACK_IMPORTED_MODULE_1__["default"], null));
};
...
/***/ 0:
/*!*****************************************************************************************************************************************************!*\
  !*** multi next-client-pages-loader?page=%2Fsecond&absolutePagePath=%2FUsers%2Fkimserver%2FGitHub%2FTraB%2FRxJs%2FRxJs_Next_js%2Fpages%2Fsecond.js ***!
  \*****************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! next-client-pages-loader?page=%2Fsecond&absolutePagePath=%2FUsers%2Fkimserver%2FGitHub%2FTraB%2FRxJs%2FRxJs_Next_js%2Fpages%2Fsecond.js! */"./node_modules/next/dist/build/webpack/loaders/next-client-pages-loader.js?page=%2Fsecond&absolutePagePath=%2FUsers%2Fkimserver%2FGitHub%2FTraB%2FRxJs%2FRxJs_Next_js%2Fpages%2Fsecond.js!./");
